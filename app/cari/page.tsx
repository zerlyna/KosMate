  ...
  return (
    <main style={{ minHeight: "100vh", backgroundColor: "#F5F6FA", fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav style={{
        ...
        <span style={{ fontSize: "13px", color: "#9CA3AF", fontWeight: 500 }}>Cari Kos</span>
      </nav>

      {/* Header */}
      <div style={{ backgroundColor: navy }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "48px 60px" }}>
          <p style={{ color: "#7EB3FF", fontSize: "12px", fontWeight: 600, letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: "10px" }}>
            Rekomendasi Personal
          </p>
          <h1 style={{ color: "white", fontSize: "32px", fontWeight: 800, letterSpacing: "-0.8px", marginBottom: "8px" }}>
            Temukan Kos yang Sesuai
          </h1>
          <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "15px" }}>
            Isi preferensi kamu di bawah ini
          </p>
        </div>
      </div>
