...
kmeans_model = joblib.load("models/model_kmeans.pkl")
...
def predict_cluster(input_user,prediksi_harga):
    fitur_cluster = [
        "Harga",
        "Jarak dari PENS",
        "WiFi",
    ...
    input_cluster = input_cluster.reindex(columns=fitur_cluster,fill_value=0)
